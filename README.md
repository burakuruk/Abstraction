🚗 Ödev1 - interface ve abstract class kullanarak Arabaların Toplam Benzin Tüketimini Hesaplama - INTERFACE kullanarak Bir Şirketin Çalışan Maaşlarını Hesaplama 
